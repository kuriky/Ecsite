package com.internousdev.templateEC.dao;
...
import com.internousdev.templateEC.dto.MyPageDTO;
import com.internousdev.templateEC.util.DBConnector;
...
public class MyPageDAO {
	public MyPageDTO getMyPageUserInfo(String item_transaction_id,String user_master_id){
		...
		String sql = "SELECT iit.item_name, ubit.total_price, ubit.total_count, ubit.pay FROM user_buy_item_transaction_id = iit.id WHERE ubit.item_transaction_id = ? AND ubit.user_master_id = ? ORDER BY ubit.insert_date DESC";
